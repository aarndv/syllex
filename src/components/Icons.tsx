...
export const SwitchIcon: React.FC<IconProps> = ({ className = "", size = 16, color = "currentColor" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SettingsIcon: React.FC<IconProps> = ({ className = "", size = 16, color = "currentColor" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SunIcon: React.FC<IconProps> = ({ className = "", size = 16, color = "currentColor" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const MoonIcon: React.FC<IconProps> = ({ className = "", size = 16, color = "currentColor" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const BookIcon: React.FC<IconProps> = ({ className = "", size = 16, color = "currentColor" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const PencilIcon: React.FC<IconProps> = ({ className = "", size = 16, color = "currentColor" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
